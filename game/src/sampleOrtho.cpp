...
SampleOrtho::~SampleOrtho()
{
	printf("Destroying Orthographic Sample\n");
...
void SampleOrtho::init()
{
    // Only init if not already done
    if(!m_program)
    {
        m_program = wolf::LoadShaders("data/ortho.vsh", "data/ortho.fsh");
    ...
    printf("Successfully initialized Ortho Sample\n");
}

void SampleOrtho::update(float dt) 
{
}

void SampleOrtho::render(int width, int height)
{
